...
Page({
    ...
    getListData: function (classid, more) {
        console.log('https://www.yishuzi.com.cn/jianjie8_xiaochengxu_api/xiaochengxu/biaoqing/?getJson=column&classid=' + classid);
        let that = this;
        let _arr = this.data.contentArray;
        wx.request({
            url: 'https://www.yishuzi.com.cn/jianjie8_xiaochengxu_api/xiaochengxu/biaoqing/?getJson=column&classid=' + classid,
            method: 'GET',
            dataType: 'json',
            success: (json) => {
    ...
    onLoad: function () {
        ...
        let _expertListi = [];
        wx.request({
            url: 'https://www.yishuzi.com.cn/jianjie8_xiaochengxu_api/xiaochengxu/biaoqing/?getJson=class',
            method: 'GET',
            dataType: 'json',
            success: (json) => {
