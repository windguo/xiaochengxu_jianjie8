...
Page({
    ...
    getListData: function (classid, more) {
        ...
        wx.request({
            url: 'https://www.yishuzi.com.cn/jianjie8_xiaochengxu_api/xiaochengxu/meiwen/?getJson=column&classid=' + classid,
            method: 'GET',
            dataType: 'json',
            success: (json) => {
    ...
    onLoad: function () {
        ...
        let _expertListi = [];
        wx.request({
            url: 'https://www.yishuzi.com.cn/jianjie8_xiaochengxu_api/xiaochengxu/meiwen/?getJson=class',
            method: 'GET',
            dataType: 'json',
            success: (json) => {
