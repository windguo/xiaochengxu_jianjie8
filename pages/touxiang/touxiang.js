...
Page({
    ...
    getListData: function (classid, more) {
        console.log('https://www.yishuzi.com.cn/jianjie8_xiaochengxu_api/xiaochengxu/touxiang/?getJson=column&classid=' + classid);
        let that = this;
    ...
    onLoad: function () {
        ...
        let _expertListi = [];
        wx.request({
            url: 'https://www.yishuzi.com.cn/jianjie8_xiaochengxu_api/xiaochengxu/touxiang/?getJson=class',
            method: 'GET',
            dataType: 'json',
            success: (json) => {
