...
Page({
    onShareAppMessage: function (res) {
        if (res.from === 'button') {
            ...
            return {
                ...
                path: '/pages/raokouling_detail/raokouling_detail?id=' + this.data.id,
                success: (res) => {
                    wx.showToast({
                        content: '分享成功'
                    });
    ...
    onLoad: function (options) {
        ...
        wx.request({
            url: 'https://www.yishuzi.com.cn/jianjie8_xiaochengxu_api/xiaochengxu/raokouling/?getJson=content&id=' + options.id,
            method: 'GET',
            dataType: 'json',
            success: (json) => {
                this.setData({
    ...
    getListData: function (classid, more) {
        ...
        wx.request({
            url: 'https://www.yishuzi.com.cn/jianjie8_xiaochengxu_api/xiaochengxu/raokouling/?getJson=column&classid=' + classid,
            method: 'GET',
            dataType: 'json',
            success: (json) => {
