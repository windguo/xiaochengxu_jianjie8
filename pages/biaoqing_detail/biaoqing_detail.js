...
Page({
    onShareAppMessage: function (res) {
        if (res.from === 'button') {
            ...
            return {
                ...
                path: '/pages/biaoqing_detail/biaoqing_detail?id=' + this.data.id,
                success: (res) => {
                    wx.showToast({
                        content: '分享成功'
                    });
    ...
    onLoad: function (options) {
        ...
        wx.request({
            url: 'https://www.yishuzi.com.cn/jianjie8_xiaochengxu_api/xiaochengxu/biaoqing/?getJson=content&id=' + options.id,
            method: 'GET',
            dataType: 'json',
            success: (json) => {
                var that = this;
